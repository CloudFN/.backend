...
try {
    if (!fs.existsSync(path.join(process.env.LOCALAPPDATA, "CloudFN"))) fs.mkdirSync(path.join(process.env.LOCALAPPDATA, "CloudFN"));
} catch (err) {
    // fallback
...
express.use((req, res, next) => {
    var XEpicErrorName = "errors.com.cloudfn.common.not_found";
